...
--3
Select * from InfoEmp where Position NOT IN ('CEO', 'PO');
...
Select *
from InfoEmp
join Employee ON InfoEmp.Id = Employee.JobID
where InfoEmp.Position = 'PO';

--6
Select Position, COUNT(*) AS WorkerCount
from InfoEmp
group by Position
